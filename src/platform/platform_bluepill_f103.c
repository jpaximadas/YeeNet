...
void platform_gpio_init(void) {
    ...
    // Setup address pins
    gpio_set_mode(platform_pinout.address0.port, GPIO_MODE_INPUT, GPIO_CNF_INPUT_FLOAT,
                  platform_pinout.address0.pin);
    gpio_set_mode(platform_pinout.address1.port, GPIO_MODE_INPUT, GPIO_CNF_INPUT_FLOAT,
                  platform_pinout.address1.pin);

    // Setup indicator pin
    gpio_set_mode(platform_pinout.indicator.port, GPIO_MODE_OUTPUT_2_MHZ, GPIO_CNF_OUTPUT_PUSHPULL,
                  platform_pinout.indicator.pin);
}
